...
const { siteUrl, salonName, telephone, email, address, geoCoordinates, googleMapsUrl, openingHoursSpecification, sameAs, contactPoint, defaultImageUrl } = useSiteMeta()
