...
const copy = computed(() => {
  if (locale.value === 'ru') {
    return {
      ...
      searchLead: 'Выберите нужную услугу, познакомьтесь с мастерами Tor и запишитесь онлайн на удобное время.',
  ...
  if (locale.value === 'en') {
    return {
      ...
      searchLead: 'Choose a service, meet the Tor team, and book a convenient time online.',
  ...
  return {
    ...
    searchLead: 'Ընտրեք ծառայությունը, ծանոթացեք Tor-ի մասնագետներին և ամրագրեք հարմար ժամը օնլայն։',
